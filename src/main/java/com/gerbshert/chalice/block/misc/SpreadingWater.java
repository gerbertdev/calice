 ...
 */
public class SpreadingWater extends ModBBase {
    static int maxWaterReach = 200;
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, maxWaterReach);
